...
1.  Let's upload the database in the memory of the computer.
...
print(paste('Maximum duration: ', format(round(max_duration / 60)), 'min = ', format(round(max_duration / 3600)), 'hours = ', format(round(max_duration / (3600 * 24))), 'days'))


```

The minimum duration seems to be a reasonable value, while the maximum one appears to be too large / not reasonable.
...
hist(reduced_df$tripduration/60, xlab = 'Duration (min)', ylab = 'Counts', main = 'Distribution of trip duration', col = 'red', xaxt= 'n')  
...
hist(less_than_1_hour$speed, xlab = 'Mean speed [km/h]', ylab = 'Counts', main = 'Average speed per user', c = 'red', xaxt = 'n')
